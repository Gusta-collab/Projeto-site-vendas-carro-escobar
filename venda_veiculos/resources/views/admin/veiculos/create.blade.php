                    ...
                    <form method="POST" action="{{ route('admin.veiculos.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="ano" id="ano" class="mt-1 block w-full rounded-md border-gray-700 bg-neutral-800 text-gray-200 shadow-sm" required placeholder="Ex: 2020">
                            </div>

                            <div>
                                <label for="quilometragem" class="block text-sm font-medium text-gray-300">Quilometragem (KM)</label>
                                <input type="number" name="quilometragem" id="quilometragem" class="mt-1 block w-full rounded-md border-gray-700 bg-neutral-800 text-gray-200 shadow-sm" required placeholder="Ex: 25000">
                            </div>
                        </div>

                        <div class="mb-4">
                            <label for="valor" class="block text-sm font-medium text-gray-300">Valor (R$)</label>
                            <input type="number" name="valor" id="valor" class="mt-1 block w-full rounded-md border-gray-700 bg-neutral-800 text-gray-200 shadow-sm" required placeholder="Ex: 50000.00" step="0.01">
                        </div>

                        <div class="mb-4">
                            <label for="detalhes" class="block text-sm font-medium text-gray-300">Detalhes (Descrição)</label>
                            <textarea name="detalhes" id="detalhes" rows="4" class="mt-1 block w-full rounded-md border-gray-700 bg-neutral-800 text-gray-200 shadow-sm"></textarea>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                            <div>
                                <label for="foto_1" class="block text-sm font-medium text-gray-300">Foto 1 (Principal - URL)</label>
                                <input type="text" name="foto_1" id="foto_1" class="mt-1 block w-full rounded-md border-gray-700 bg-neutral-800 text-gray-200 shadow-sm" placeholder="Cole endereço de imagem aqui">
                            </div>
                            <div>
                                <label for="foto_2" class="block text-sm font-medium text-gray-300">Foto 2 (URL)</label>
                                <input type="text" name="foto_2" id="foto_2" class="mt-1 block w-full rounded-md border-gray-700 bg-neutral-800 text-gray-200 shadow-sm" placeholder="Cole endereço de imagem aqui">
                            </div>
                            <div>
                                <label for="foto_3" class="block text-sm font-medium text-gray-300">Foto 3 (URL)</label>
                                <input type="text" name="foto_3" id="foto_3" class="mt-1 block w-full rounded-md border-gray-700 bg-neutral-800 text-gray-200 shadow-sm" placeholder="Cole endereço de imagem aqui">
                            </div>
                        </div>
